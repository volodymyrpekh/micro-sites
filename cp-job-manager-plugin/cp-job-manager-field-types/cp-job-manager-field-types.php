<?php
/*
  Plugin Name: CP Job Manager Field Types
  Plugin URI: 
  Description: Add WP Job Manger field for available spaces
  Version: 1.0.0
  Author: Systemo.biz
  Author URI: http://www.systemo.biz
 */
...
function cp_scripts_method() {
	...
	wp_enqueue_script( 'cp_avail_script', plugins_url( 'js.js', __FILE__ ),array( 'jquery-ui-datepicker' ) );
...
function my_enqueue() {
	...
	$myStyleUrl = plugins_url( 'css.css', __FILE__ );
