...
$(window).resize(function() {
    $('.accordion_header').each(function() {
        height_accord = ($(this).outerHeight()/2) - 2;
        $(this).find(".accordion_before").css({"border-top-width": + height_accord + "px", "border-bottom-width": + height_accord + "px"});
    });
});
...
$(document).ready(function() {
    $('.accordion_header').each(function() {
        height_accord = ($(this).outerHeight()/2) - 2;
        $(this).append("<div class='accordion_before' style='border-top-width: " + height_accord + "px; border-bottom-width: " + height_accord + "px;'></div>");
    });
});
